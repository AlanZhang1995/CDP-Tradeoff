...
inputfile='deNoisedMnist.npz' # 'NoisyMnist_1.npz' "deNoisedMnist.npz"
Trained_model='./checkpoint_9919'

'''
#save noisy data
noise=np.random.normal(0,noise_std,mnist.test.shape)
test_image=mnist.test.images+noise
noise=np.random.normal(0,noise_std,mnist.validation.shape)
valid_image=mnist.validation.images+noise
noise=np.random.normal(0,noise_std,mnist.train.shape)
