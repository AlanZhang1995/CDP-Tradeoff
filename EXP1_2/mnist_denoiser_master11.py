...
parser.add_argument('--outdir', type=str, default='/media/alan/SteinsGate/github_code/mnist/TensorFlow_WGAN/improved_wgan_training-master/samples/mnist', help='Dir for saving samples')
