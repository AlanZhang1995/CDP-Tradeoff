...
parser.add_argument('--checkpointdir', type=str, default='/media/alan/SteinsGate/github_code/mnist/TensorFlow_WGAN/improved_wgan_training-master-sort/samples/mnist/checkpoint', help='dir saves models')
...
def Generator(n_samples, noise=None):
    if noise is None:
        noise = tf.random_normal([n_samples, 784])
